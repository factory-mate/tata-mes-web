...
export function listRoutes() {
  return request({
    ...
    // url: import.meta.env.VITE_APP_BASE_API+'/api/Menu/GetTree',
    url: import.meta.env.VITE_APP_BASE_API+'/api/AuthHelper/GetMenuAuth',
    method: 'get'
  });
}
...
export function listMenus(queryParams: MenuQuery): AxiosPromise<Menu[]> {
  return request({
    url: import.meta.env.VITE_APP_BASE_API+'/api/v1/menus',
    method: 'get',
    params: queryParams
  });
}
