...
const tableAxios = async () => {
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore
  let obj = JSON.parse(window.sessionStorage.getItem('memAdmin'));
  let data = {
...
const clickEdit = (obj: any) => {
  ...
  $bus.emit('TabTitleVal', { name: Route.name, title: '备忘录管理编辑' });
};
</script>
