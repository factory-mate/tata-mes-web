        ...
        <el-card class="maintain_card">
            <div class="search_main">
                ...
                ref="formlabelref" :model="form" :inline="true" label-width="120px">
                    ...
                    <el-form-item label="门型：" prop="name">
                    ...
                    <el-form-item label="产品分类3：" prop="name">
                        <el-input v-model="form.project" placeholder="请输入">
                            <template #append>
                                <el-icon @click="clickModel"><MoreFilled /></el-icon>
                            </template>
                    ...
                    <el-form-item label="锁具类型：" prop="optVal">
                    ...
                    <el-form-item label="合页类型：" prop="optVal">
                        <el-select v-model="form.optVal"  class="selectSty">
                            <el-option
                              v-for="item in options"
                              :key="item.value"
                    ...
                    <el-form-item label="开向类型：" prop="optVal">
                        <el-select v-model="form.optVal"  class="selectSty">
                            <el-option
                              v-for="item in options"
                              :key="item.value"
                    ...
                    <el-form-item label="玻璃类型：" prop="optVal">
                        <el-select v-model="form.optVal"  class="selectSty">
                            <el-option
                              v-for="item in options"
                              :key="item.value"
                    ...
                    <el-form-item label="长区间值：" prop="name">
                        <el-input v-model="form.project" placeholder="请输入">
                            <template #append>
                                <el-icon @click="clickModel"><MoreFilled /></el-icon>
                            </template>
                    ...
                    <el-form-item label="宽区间值：" prop="name">
                        <el-input v-model="form.project" placeholder="请输入">
                            <template #append>
                                <el-icon @click="clickModel"><MoreFilled /></el-icon>
                            </template>
                    ...
                    <el-form-item label="厚区间值：" prop="name">
                        <el-input v-model="form.project" placeholder="请输入">
                            <template #append>
                                <el-icon @click="clickModel"><MoreFilled /></el-icon>
                            </template>
                    ...
                    <el-form-item label="材质方向：" prop="optVal">
                        <el-select v-model="form.optVal"  class="selectSty">
                            <el-option
                              v-for="item in options"
                              :key="item.value"
                     ...
                     <el-form-item label="规则编码：" prop="date" class="date_sty">
                        <el-input style="width:230px" type="text" v-model="form.project" placeholder="请输入" />
                    </el-form-item>
                    <el-form-item label="是否生存：" prop="optVal">
                        <el-select v-model="form.optVal"  class="selectSty">
                            <el-option
                              v-for="item in options"
                              :key="item.value"
                    ...
                    <el-form-item label="贴向：" prop="optVal">
                        <el-select v-model="form.optVal"  class="selectSty">
                            <el-option
                              v-for="item in options"
                              :key="item.value"
...
import { Delete,Plus,Refresh, Edit,MoreFilled, Search,ArrowDown, View, Document } from '@element-plus/icons-vue'
...
// import model from './components/structureModel.vue'
...
const dataVal: columnType[] =[
        // 表格配置数据
        {checkType:true, label: '规则编号', prop: 'id', headerSlot:true,slot:1,minwidth:'150px'},
        {checkType:true, label: '门型', prop: 'name1',headerSlot:true ,slot:0,minwidth:'150px'},
        {checkType:true, label: '产品分类名称', prop: 'name2',headerSlot:true ,slot:0,minwidth:'100px'},
        {checkType:true, label: '产品分类名称2', prop: 'name3', headerSlot:true,slot:0,minwidth:'150px'},
        {checkType:true, label: '产品分类名称3', prop: 'name4', headerSlot:true,slot:0,minwidth:'150px'},
        {checkType:true, label: '结构名称', prop: 'name5', headerSlot:true,slot:0,minwidth:'100px'},
        {checkType:true, label: '产品编码', prop: 'name5', headerSlot:true,slot:0,minwidth:'100px'},
        {checkType:true, label: '产品名称', prop: 'name5', headerSlot:true,slot:0,minwidth:'100px'},
