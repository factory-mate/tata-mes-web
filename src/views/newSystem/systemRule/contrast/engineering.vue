        ...
        <el-card class="maintain_card">
            <div class="search_main">
                ...
                ref="formlabelref" :model="form" :inline="true" label-width="120px">
                    ...
                    <el-form-item label="分类名称：" prop="project">
                        <el-input
                            v-model="form.project"
                            placeholder="请输入"
                        >
...
import model from './components/engineeringModel.vue'
...
const dataVal: columnType[] =[
        // 表格配置数据
        {checkType:true, label: '产品编码', prop: 'id', headerSlot:true,slot:1,minwidth:'130px'},
        {checkType:true, label: '产品名称', prop: 'name1',headerSlot:true ,slot:0,minwidth:'130px'},
        {checkType:true, label: '分类编码', prop: 'name1',headerSlot:true ,slot:0,minwidth:'130px'},
        {checkType:true, label: '分类名称', prop: 'name1',headerSlot:true ,slot:0,minwidth:'130px'},
        {checkType:true, label: 'Excel列名', prop: 'name1',headerSlot:true ,slot:0,minwidth:'150px'},
        {checkType:true, label: '转换后结构编码', prop: 'name1',headerSlot:true ,slot:0,minwidth:'170px'},
