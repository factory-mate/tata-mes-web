        ...
        <el-card class="maintain_card">
            <div class="search_main">
                ...
                ref="formlabelref" :model="form" :inline="true" label-width="120px">
                    <el-form-item label="来源：" prop="optVal">
                    ...
                    <el-form-item label="来源结构编码：" prop="date" class="date_sty">
                        <el-input style="width:230px" type="text" v-model="form.project" placeholder="请输入" />
                    </el-form-item>
                    <el-form-item label="来源结构名称：" prop="date" class="date_sty">
                        <el-input style="width:230px" type="text" v-model="form.project" placeholder="请输入" />
                    </el-form-item>
                    <el-form-item label="MES结构编码：" prop="name">
                        <el-input
                    ...
                    <el-form-item label="MES结构名称：" prop="project">
                        <el-input
                            v-model="form.project"
                            placeholder="请输入"
                        >
...
const dataVal: columnType[] =[
        // 表格配置数据
        {checkType:true, label: 'MES结构编码', prop: 'id', headerSlot:true,slot:1,minwidth:'150px'},
        {checkType:true, label: 'MES结构名称', prop: 'name1',headerSlot:true ,slot:0,minwidth:'150px'},
        {checkType:true, label: '来源', prop: 'name2',headerSlot:true ,slot:0,minwidth:'100px'},
        {checkType:true, label: '来源结构编码', prop: 'name3', headerSlot:true,slot:0,minwidth:'150px'},
        {checkType:true, label: '来源结构名称', prop: 'name4', headerSlot:true,slot:0,minwidth:'150px'},
        {checkType:true, label: '是否已同步', prop: 'name5', headerSlot:true,slot:0,minwidth:'100px'},
