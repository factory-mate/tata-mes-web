        ...
        <el-card class="maintain_card">
            <div class="search_main">
                ...
                ref="formlabelref" :model="form" :inline="true" label-width="120px">
                    ...
                    <el-form-item label="产品分类编码：" prop="project">
                        <el-input
                            v-model="form.project"
                            placeholder="请输入"
                        >
                    ...
                    <el-form-item label="产品分类名称：" prop="project">
                        <el-input
                            v-model="form.project"
                            placeholder="请输入"
                        >
        ...
        <el-card>
            <div style="float: right;margin-bottom:10px">
                <el-radio-group v-model="isCollapse" style="    vertical-align: top;margin-right: 10px">
                    <el-radio-button :label="false" @click="clickNew">新增</el-radio-button>
                    <el-radio-button :label="true">复制</el-radio-button>
                </el-radio-group>
...
import model from './components/stockClassifyModel.vue'
...
const dataVal: columnType[] =[
        // 表格配置数据
        {checkType:true, label: '产品编码', prop: 'id', headerSlot:true,slot:1,minwidth:'120px'},
        {checkType:true, label: '产品名称', prop: 'name1',headerSlot:true ,slot:0,minwidth:'120px'},
        {checkType:true, label: '产品分类编码', prop: 'name2',headerSlot:true ,slot:0,minwidth:'150px'},
        {checkType:true, label: '产品分类名称', prop: 'name3', headerSlot:true,slot:0,minwidth:'150px'},
