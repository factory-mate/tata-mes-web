        ...
        <el-card class="maintain_card">
            <div class="search_main">
                ...
                ref="formlabelref" :model="form" :inline="true" label-width="120px">
                    <el-form-item label="MES编码：" prop="name">
                        <el-input
                    ...
                    <el-form-item label="MES名称：" prop="project">
                        <el-input
                            v-model="form.project"
                            placeholder="请输入"
                        >
                    ...
                    <el-form-item label="来源类型：" prop="optVal">
                        <el-select v-model="form.optVal"  class="selectSty">
                            <el-option
                              v-for="item in options"
                              :key="item.value"
                    ...
                    <el-form-item label="来源名称：" prop="date" class="date_sty">
...
import model from './components/HingeLockModel.vue'
...
const dataVal: columnType[] =[
        // 表格配置数据
        {checkType:true, label: '来源', prop: 'id', headerSlot:true,slot:1,minwidth:'150px'},
        {checkType:true, label: 'MES编码', prop: 'name1',headerSlot:true ,slot:0,minwidth:'150px'},
        {checkType:true, label: 'MES名称', prop: 'name2',headerSlot:true ,slot:0,minwidth:'100px'},
        {checkType:true, label: '来源类型', prop: 'name3', headerSlot:true,slot:0,minwidth:'150px'},
        {checkType:true, label: '来源编码', prop: 'name4', headerSlot:true,slot:0,minwidth:'150px'},
        {checkType:true, label: '来源名称', prop: 'name5', headerSlot:true,slot:0,minwidth:'100px'},
