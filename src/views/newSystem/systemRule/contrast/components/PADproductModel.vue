<template>
    ...
    >
        <el-form :model="form" :rules="rules"  ref="ruleFormRef">
            ...
            <el-form-item label="MES产品编码：" prop="name1" :label-width="formLabelWidth">
                <el-input
                    v-model="form.name1"
                    placeholder="请输入"
                >
            ...
            <el-form-item label="MES产品名称：" prop="name2" :label-width="formLabelWidth">
                <el-input
                    v-model="form.name2"
                    placeholder="请输入"
                >
            ...
            <el-form-item label="来源物料编码：" :label-width="formLabelWidth">
                <el-input v-model="form.name"  placeholder="请输入" />
            </el-form-item>
            <el-form-item label="来源物料名称：" :label-width="formLabelWidth">
                <el-input v-model="form.name"  placeholder="请输入"/>
            </el-form-item>
