<template>
    ...
    >
        <el-form :model="form" :rules="rules"  ref="ruleFormRef">
            ...
            <el-form-item label="产品编码：" prop="name1" :label-width="formLabelWidth">
                <el-input
                    v-model="form.name1"
                    placeholder="请输入"
                >
            ...
            <el-form-item label="分类编码：" prop="name1" :label-width="formLabelWidth">
                <el-input
                    v-model="form.name1"
                    placeholder="请输入"
                >
        ...
        <el-table :data="tableData" border style="width: 100%">
            <el-table-column prop="date" label="Excel列名"  />
            <el-table-column prop="name" label="转换后结构编码"  />
            <el-table-column prop="name" label="转换后结构名称" />
        </el-table>
