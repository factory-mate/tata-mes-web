<template>
    ...
    >
        <el-form :model="form" :rules="rules"  ref="ruleFormRef">
            ...
            <el-form-item label="MES结构编码：" prop="name1" :label-width="formLabelWidth">
                <el-input
                    v-model="form.name1"
                    placeholder="请输入"
                >
            ...
            <el-form-item label="MES结构名称："  :label-width="formLabelWidth">
                <el-input
                    v-model="form.name2"
                    placeholder="请输入"
                >
            ...
            <el-form-item label="来源：" prop="name1"  :label-width="formLabelWidth">
                <el-select v-model="form.name" placeholder="请选择" style="width: 100%;">
                    <el-option label="Zone one" value="shanghai" />
                    <el-option label="Zone two" value="beijing" />
                </el-select>
            </el-form-item>
            <el-form-item label="来源结构编码：" prop="name1"  :label-width="formLabelWidth">
                <el-input v-model="form.name"  placeholder="请输入" />
            </el-form-item>
            <el-form-item label="来源结构名称：" :label-width="formLabelWidth">
                <el-input v-model="form.name"  placeholder="请输入"/>
            </el-form-item>
