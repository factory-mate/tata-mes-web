<template>
    ...
    >
        <el-form :model="form" :rules="rules"  ref="ruleFormRef">
            <el-form-item label="物流：" prop="name1"  :label-width="formLabelWidth">
                <el-input v-model="form.name"  placeholder="请输入" />
            </el-form-item>
            <el-form-item label="城市："  prop="name1" :label-width="formLabelWidth">
                <el-input v-model="form.name"  placeholder="请输入"/>
            </el-form-item>
            <el-form-item label="优先级："  prop="name1" :label-width="formLabelWidth">
                <el-input v-model="form.name"  placeholder="请输入"/>
            </el-form-item>
