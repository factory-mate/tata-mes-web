        ...
        <el-card class="maintain_card">
            <div class="search_main">
                ...
                ref="formlabelref" :model="form" :inline="true" label-width="120px">
                    ...
                    <el-form-item label="合包类型编码：" prop="name">
                        <el-input
...
import model from './components/equipmentModel.vue'
...
const dataVal: columnType[] =[
        // 表格配置数据
        {checkType:true, label: '工位编码', prop: 'id', headerSlot:true,slot:1,minwidth:'150px'},
        {checkType:true, label: '工位名称', prop: 'name1',headerSlot:true ,slot:0,minwidth:'150px'},
