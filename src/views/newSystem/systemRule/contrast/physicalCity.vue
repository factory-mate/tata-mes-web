...
import model from './components/physicalCityModel.vue'
...
const dataVal: columnType[] =[
        // 表格配置数据
        {checkType:true, label: '物流', prop: 'id', headerSlot:true,slot:1,minwidth:'140px'},
        {checkType:false, label: '城市', prop: 'name', slotName: 'shebei' ,headerSlot:true ,slot:0,minwidth:'140px'},
        {checkType:true, label: '优先级', prop: 'name1',headerSlot:true ,slot:0,minwidth:'140px'},
        {checkType:true, label: '备注', prop: 'name2',headerSlot:true ,slot:0,minwidth:'140px'},
