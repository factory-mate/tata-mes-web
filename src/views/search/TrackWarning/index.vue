...
const tableButton = ref([
  { checkType: true, label: '操作', slotName: 'button' }
]) as any;
...
const clickTableBut = (scopeItem: any, butItem: any) => {
  console.log(scopeItem, '--1---table按钮');
  console.log(butItem, '--2--=table按钮');
...
const ExportOne = (val: any) => {
  ...
  exportAnalysisHooks(ExcelData, '货道库存预警');
};
// 导出所有
const ExportAll = (val: any) => {
  ...
  exportAnalysisHooks(ExcelData, '货道库存预警-所有');
};
