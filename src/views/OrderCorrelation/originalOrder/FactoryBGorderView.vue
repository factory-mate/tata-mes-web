...
const tableAxios = async () => {
  ...
  if (Route.name == 'originalOrder') {
    valDat = Conditions.value
      ? 'cVouchTypeCode in (0,1,2,3,4,5,10,11) && ' +
        Conditions.value +
        ' && iDefindParm13 = 0'
      : 'cVouchTypeCode in (0,1,2,3,4,5,10,11) &&' + ' iDefindParm13 = 0';
  }
  let data = {
    ...
    data: {
      ...
      forList: {
        ...
        Conditions: Conditions.value
          ? 'cVouchTypeCode in (0,1,2,3,4,5,10,11) && ' + Conditions.value
          : 'cVouchTypeCode in (0,1,2,3,4,5,10,11)'
      },
...
const BatchInspection = (obj: any) => {
  ...
  let dataVal = {
    ...
    data: {
      ...
      //     "PageSize": queryParams.PageSize,
      //     "OrderByFileds": OrderByFileds.value,
      //     "Conditions": Conditions.value ? 'cVouchTypeCode in (0,1,2,3,4,5,10,11) && iDefindParm13 = 0 && ' + Conditions.value : 'cVouchTypeCode in (0,1,2,3,4,5,10,11) && iDefindParm13 = 0'
      // },
      // "bIsSearch":  sendId.value.length ? false : true,
      // // "iDs": sendId.value
      iDs: sendId.value ? sendId.value : []
