    ...
    <div class="maintain">
        ...
        <el-card class="maintain_card">
            <div class="search_main">
                ...
                ref="formlabelref" :model="form" :inline="true" label-width="120px">
                    ...
                    <el-form-item label="ERP生产订单：" prop="project">
                    ...
                    <el-form-item label="MES工单号：" prop="project">
                        <el-input v-model="form.project"  placeholder="请输入">
                        </el-input>
                    </el-form-item>
        ...
        <el-card>
            <div style="float: right;margin-bottom:10px">
                ...
                <el-button  :icon="Refresh">审核</el-button>
                <el-dropdown  style="margin-left: 10px;">
                    ...
                    <template #dropdown>
                      <el-dropdown-menu>
                        <el-dropdown-item>TATA</el-dropdown-item>
            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="name" label="ERP生产订单" min-width="120"  />
                <el-table-column prop="name" label="MES工单号" min-width="100"  />
                <el-table-column prop="name" label="所属组织" min-width="90" />
                ...
                <el-table-column prop="name" label="计划开工日期" min-width="120" />
                <el-table-column prop="name" label="计划完工日期" min-width="120" />
                <el-table-column prop="name" label="实际开工日期" min-width="120" />
                <el-table-column prop="name" label="实际完工日期" min-width="120" />
                <el-table-column prop="name" label="交货日期"  min-width="90" />
                <el-table-column prop="name" label="审单状态"  min-width="90" />
                <el-table-column prop="name" label="挂起" />
                <el-table-column prop="name" label="制单日期"  min-width="90" />
                <el-table-column prop="name" label="审核人" />
                <el-table-column prop="name" label="审核日期"  min-width="90" />
                <el-table-column prop="name" label="客户名称"  min-width="90" />
                <el-table-column prop="name" label="所属地区"  min-width="90" />
            </el-table>
