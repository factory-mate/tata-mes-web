<template>
    <div class="xunjian_box" style="padding: 20px;">
        <el-card class="form_card1">
            <div class="btns">
                <el-button type="primary" @click="goback(ruleFormRef)">返回</el-button>
                ...
                <el-button @click="save(ruleFormRef)" type="primary">完工</el-button>
                <el-button @click="save(ruleFormRef)" type="primary">申报故障</el-button>
                ...
                <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="110px" class="demo-ruleForm"
                    ...
                    <el-form-item label="计划巡检日期" prop="time">
                        <div class="block">
                            ...
                            <el-date-picker v-model="ruleForm.time" type="date" placeholder="选择日期" :disabled="changeForm ? true : false"/>
                        </div>
                    </el-form-item>
                    ...
                    <el-form-item label="设备名称" prop="name">
                        <el-input v-model="ruleForm.name" class="inpt" style="width: 220px;" :disabled="changeForm ? true : false"/>
                    </el-form-item>
        ...
        <el-card>
            <MyTable  :tableData="tableData" :tableColumns="tableColumns" :selection="true" @dblclick="doubleThing()">
                <template #handler>
...
const { dialogType, titleName, form, tableSet, options1,queryParams,total } = toRefs(dialogdata)
interface dataType {
    id?: string
    date?: string
    name?: string
