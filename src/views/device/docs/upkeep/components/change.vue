        ...
        <el-card class="form_card1">
            ...
            <div class="heade_form">
                <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="110px" class="demo-ruleForm"
                    :inline="true">
                    <el-form-item label="保养单号" prop="odd">
                        <el-input v-model="ruleForm.odd" class="inpt" />
                    </el-form-item>
                    <el-form-item label="计划保养日期" prop="time">
                        <div class="block">
                    ...
                    <el-form-item label="是否完工" prop="complete">
                        <el-select v-model="ruleForm.complete" placeholder="">
                    ...
                    <el-form-item label="使用位置" prop="place">
                        <el-input v-model="ruleForm.place" placeholder="" class="input-with-select">
                            <template #append>
                                <el-button :icon="MoreFilled" @click="clickModel" />
                            </template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="保养负责人" prop="person">
                        <el-input v-model="ruleForm.person" placeholder="" class="input-with-select">
                            <template #append>
                                <el-button :icon="MoreFilled" @click="clickModel" />
                            </template>
                        </el-input>
                    ...
                    <el-form-item label="是否已申报" prop="declare">
                        <el-select v-model="ruleForm.declare" placeholder="">
                            <el-option label="是" value="是" />
                            <el-option label="否" value="否" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="备注" prop="remark">
                        <el-input v-model="ruleForm.remark" class="inpt" />
                    </el-form-item>
                </el-form>
            </div>
