<template>
    <div class="xunjian_box" style="padding: 20px;">
        <el-card class="form_card1" style="padding-top: 50px;">
            <div class="btns">
                <el-button @click="gouback(ruleFormRef)" type="primary">返回</el-button>
                <el-button @click="change(ruleFormRef)" type="primary">{{ btnName }}</el-button>
                <el-button @click="starte(ruleFormRef)" type="primary">开始</el-button>
                <el-button @click="finish(ruleFormRef)" type="primary">完工</el-button>
                <el-button @click="apply(ruleFormRef)" type="primary">领料申请</el-button>
            ...
            <div class="heade_form" v-show="showForm">
                <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="110px" class="demo-ruleForm"
                    ...
                    <el-form-item label="故障类别" prop="type">
                        <el-select v-model="ruleForm.type" placeholder="" class="inpt" :disabled="changeForm ? true : false">
                            <el-option label="是" value="是" />
                            <el-option label="否" value="否" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="维修单号" prop="name">
                        <el-input v-model="ruleForm.name" class="inpt" :disabled="changeForm ? true : false" />
                    </el-form-item>
                    <el-form-item label="制单日期" prop="time">
                        <div class="block">
                            <span class="demonstration"></span>
                            <el-date-picker v-model="ruleForm.time" type="date" placeholder="选择日期"
                                style="width:250px ;" :disabled="changeForm ? true : false" />
                        </div>
                    </el-form-item>
                    ...
                    <el-form-item label="维修操作类型" prop="service">
                        <el-select v-model="ruleForm.service" placeholder="" class="inpt" :disabled="changeForm ? true : false" >
                            <el-option label="是" value="是" />
                            <el-option label="否" value="否" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="开始维修时间" prop="startime">
                        <el-time-select v-model="ruleForm.startime" start="00:00" step="00:30" end="23:59" placeholder="Select time"
                            format="hh:mm A" class="inpt" :disabled="changeForm ? true : false"/>
                    </el-form-item>
                    ...
                    <el-form-item label="实际工时" prop="name">
                        <el-input v-model="ruleForm.name" class="inpt" :disabled="changeForm ? true : false"/>
                    </el-form-item>
                    <el-form-item label="来源类型" prop="sourcetype">
                        <el-select v-model="ruleForm.sourcetype" placeholder="" class="inpt" :disabled="changeForm ? true : false">
                            <el-option label="是" value="是" />
                            <el-option label="否" value="否" />
                        </el-select>
                    </el-form-item>
...
const { dialogType, titleName,  tableSet,queryParams,total  } = toRefs(dialogdata)
// form数据
...
const gouback=(val:any)=>{
    router.push('repair')
}
const starte=(val:any)=>{
