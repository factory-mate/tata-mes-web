            ...
            <div class="search" >
                <el-form ref="queryFormRef" :model="queryParams" :inline="true" label-width="110px">
                    ...
                    <el-form-item prop="name" label="设备名称：" class="elitem">
                        <el-input v-model="topForm.name" placeholder="请输入" >
                        </el-input>
                    </el-form-item>
                    <el-form-item prop="code" label="设备编码：" class="elitem">
                        <el-input v-model="topForm.code" placeholder="请输入" >
                        </el-input>
                    </el-form-item>
                    <el-form-item prop="person" label="维修人：" class="elitem">
                        <div class="mt-4">
                            <el-input v-model="topForm.person" placeholder="" class="input-with-select">
                                <template #append>
            ...
            <MyTable v-if="tabType" :tableData="tableData" :tableColumns="tableColumns" :selection="true" @dblclick="doubleThing()">
                <template #handler>
                    ...
                    <el-button size="small" type="danger" :icon="CircleCheck"
                        @click.stop="handlefinish(scope.$index, scope.row)">完工</el-button>
                        </template>
                    </el-table-column>
                </template>
            </MyTable>
