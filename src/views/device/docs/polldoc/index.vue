<template>
    <div class="part_box" style="padding: 20px;">
        ...
        <div class="search" style="height: 100%; overflow: hidden; padding-right: 20px;">
            <el-form ref="queryFormRef" :model="queryParams" :inline="true" label-width="120px">
                ...
                <el-form-item prop="time" label="巡检日期:" class="elitem">
                ...
                <el-form-item prop="state" label="完工状态:" class="elitem">
                    <el-select v-model="topForm.state" class="m-2" placeholder="是否完工">
        ...
        <el-card>
            <template #header>
                <el-form-item class="form_btn">
                    <el-button  :icon="Refresh" @click="updata" type="primary">刷新</el-button>
                </el-form-item>
                <el-form-item class="form_btn">
...
import { Search, Refresh, Edit, Delete, MoreFilled, CircleCheck } from '@element-plus/icons-vue';
...
const { dialogType, titleName, queryParams, tableSet, total, options } = toRefs(dialogdata)
interface dataType {
    id?: string
    date?: string
    name?: string
...
const handleEdit = (index: any, row: any) => {
    router.push({ path: 'changepoll' })
    // EditFormVisible.value = true
}
// 双击跳转
const doubleThing = () => {
    router.push({ path: 'detailpoll' })
    console.log(111);
