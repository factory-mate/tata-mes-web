<template>
  <el-dialog v-model="dialogVisible" :title="dialogTitle" center width="40%">
    <h1>待定。。。。。</h1>
    <!-- <el-form :model="form" :rules="rules"  ref="ruleFormRef">
            <el-form-item label="用户编码：" :label-width="formLabelWidth"  prop="name1" >
                <el-input v-model="form.name"  placeholder="请输入" />
            </el-form-item>
            <el-form-item label="用户名称：" :label-width="formLabelWidth" prop="name1">
                <el-input v-model="form.name"  placeholder="请输入"/>
            </el-form-item>
