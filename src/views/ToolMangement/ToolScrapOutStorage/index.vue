            ...
            <template #default="scope">
              ...
              >
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item
                      v-for="item in tableButton.sclie(2)"
                      :key="item.Resource.cAttributeName"
                    >
                      <el-button
                        type="primary"
...
const clickTableBut = (scope: any, event: any) => {
  console.log(event.cAttributeCode, '---333');
  ...
  let data = {
    ...
    data: {
      ...
      Conditions: Conditions.value
        ? 'cVouchTypeCode=6 && cInOutTypeCode=2 && ' + Conditions.value
        : 'cVouchTypeCode=6 && cInOutTypeCode=2'
    }
  };
  try {
    ElLoading.service({ lock: true, text: '加载中.....' });
