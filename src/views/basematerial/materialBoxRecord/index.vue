...
const ExportOne = (val: any) => {
  ...
  console.log(EoneData, '导出当前');
  // DataApi(EoneData).then((res:any)=>{
  //     if(res.status==200){
  //         ElMessage({
  //             message:res.msg,
  //             type: 'success',
