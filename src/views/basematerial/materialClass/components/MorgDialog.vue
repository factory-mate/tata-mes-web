            ...
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm"
                ...
                <template v-for="item in FormData" :key="item.UID">
                    <el-form-item v-if="item.Resource.cAttributeCode !== 'Data' && item.IsShow == true"
                        ...
                        <el-input v-if="item.cControlTypeCode == 'TextBoxLink'" :disabled="disabledFun(item)"
                ...
                <el-form-item>
                    <el-button type="primary"  :disabled="title=='物料分类详情'?true:false" @click="submitForm(ruleFormRef, item)" v-for="item in Btn" :key="item.UID">
...
const { dialogType, titleName, codeType, MulitChoose, AttributeCode } = toRefs(data)
// 搜索弹框事件
