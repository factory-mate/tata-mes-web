<template>
    ...
    <div class="maintain">
        ...
        <el-card>
            <!-- 按钮区域 -->
            <ButtonViem :ToolBut="But"  @clickDelete="clickDel" @ExportAll="ExportAll" @ExportOne="ExportOne"></ButtonViem>
            <!-- 表格区域 -->
...
const tableAxios = async () => {
    let data = {
        ...
        data: {
            ...
            "OrderByFileds": 'dActDateEnd,cType',
...
const ExportAll = async (obj: any) => {
    ...
    exportAnalysisHooks(data,'时段齐套统计-所有')
}
//按钮导出当前页
const ExportOne = async (obj: any) => {
    ...
    exportAnalysisHooks(data,'时段齐套统计-当前')
