    ...
    <el-card>
      ...
      >
        ...
        <el-table-column label="操作" align="center" fixed="right" width="240">
          <template #default="scope">
            <el-button type="primary" plain round size="small" :icon="Plus" @click.stop="handleAdd(scope.row)"
              >新增
            </el-button>
            <el-button type="success" plain round size="small" :icon="Edit" @click.stop="handleUpdate(scope.row)"
              >编辑
            </el-button>
            <el-button type="danger" plain round size="small" :icon="Delete" @click.stop="handleDelete(scope.row)">
              删除
            </el-button>
          </template>
        </el-table-column>
