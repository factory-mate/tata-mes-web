  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        ...
        fixed="right" align="center" width="260">
          <template #default="scope">
            <el-button
              type="success"
              plain round size="small" :icon="Plus"
            ...
            <el-button type="danger" plain round size="small" :icon="Edit" @click.stop="handleDelete(scope.row)">
              删除
            </el-button>
          </template>
        </el-table-column>
