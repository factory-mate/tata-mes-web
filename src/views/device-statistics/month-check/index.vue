...
const chartOptions = computed(() => ({
  ...
  yAxis: [
    { type: 'value', name: '数量', min: 0, max: 150 },
    { type: 'value', name: '完成率', min: 0, max: 100 }
  ],
  series: [
    { type: 'bar', name: '计划点检数', label: { show: true, position: 'top' } },
    { type: 'bar', name: '完成点检数', label: { show: true, position: 'top' } },
    {
      type: 'line',
      name: '完成率',
  ...
  dataset: {
    dimensions: [
      ...
      { name: 'nPlanQuantity', displayName: '计划点检数' },
      { name: 'nEndQuantity', displayName: '完成点检数' },
