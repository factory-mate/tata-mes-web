  ...
  let data = {
    ...
    data: {
      ...
      Conditions: Conditions.value
        ? 'cVouchTypeCode = 01 && iStatus!=0 && ' + Conditions.value
        : 'cVouchTypeCode = 01 && iStatus!=0'
    }
  };
  try {
