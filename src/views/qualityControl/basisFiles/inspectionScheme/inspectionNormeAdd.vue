...
// const guid=ref('9262aaea-7a18-49bc-a899-4aaf072f75b4') as any
const guid = ref('') as any;
const ExpotrFile = (obj: any) => {
  console.log(obj, '---d');
  guid.value = obj.data;
};
//新增保存
const SaveAdd = (obj: any) => {
  ...
  //     return false
  // }
  obj.pathName = 'inspectionSchemeEdit';
  obj.MID = rowId.value;
  obj.tableData = [{ MID: guid.value }];
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore
