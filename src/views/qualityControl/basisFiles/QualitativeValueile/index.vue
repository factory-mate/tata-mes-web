<template>
  ...
  <div class="maintain">
    <el-card style="margin-right: 10px">
      <div class="treeSty" style="width: 320px">
        <leftTree
          ref="treeRef"
          :treeData="treeData"
...
const tableAxios = async () => {
  loading.value = true;
  let tt = {
    cAttributeCode: 'cParmValueClassCode',
    cAttributeCodeValue: treeNodeValue.value.cParmValueClassCode
      ? treeNodeValue.value.cParmValueClassCode
      : '',
    cConditions: '='
  };
  ClickSearchVal.value = ClickSearchVal.value.filter(
    (item: any) => item.cAttributeCode !== 'cParmValueClassCode'
  );
